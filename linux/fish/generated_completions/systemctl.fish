# systemctl
# Autogenerated from man page /usr/lib/jvm/default/man/man1/systemctl.1.gz
...
complete -c systemctl -l plain -d 'is implied'
complete -c systemctl -l kill-whom -d 'to select which process to kill.  Use'
...
complete -c systemctl -l no-warn -d 'can be used to suppress the warning'
...
complete -c systemctl -l drop-in -d 'is specified, the given drop-in file name will be used instead of the default…'
