# devlink
# Autogenerated from man page /usr/lib/jvm/default/man/man8/devlink.8.gz
...
complete -c devlink -s i -l iec -d 'Print human readable rates in IEC units (e. g.  1Ki = 1024)'
complete -c devlink -s x -l hex -d 'Print dump numbers in hexadecimal format. SS  OBJECT'
