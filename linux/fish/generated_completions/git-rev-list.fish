# git-rev-list
# Autogenerated from man page /usr/lib/jvm/default/man/man1/git-rev-list.1.gz
...
complete -c git-rev-list -l exclude-hidden -d 'Do not include refs that would be hidden by git-receive-pack or git-upload-pa…'
