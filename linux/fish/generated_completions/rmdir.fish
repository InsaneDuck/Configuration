# rmdir
# Autogenerated from man page /usr/lib/jvm/default/man/man1/rmdir.1.gz
complete -c rmdir -l ignore-fail-on-non-empty -d 'ignore each failure to remove a non-empty directory'
