# ip
# Autogenerated from man page /usr/lib/jvm/default/man/man8/ip.8.gz
...
complete -c ip -s p -o pretty -d 'The default JSON format is compact and more efficient to parse but hard for m…'
complete -c ip -o echo -d 'Request the kernel to send the applied configuration back'
