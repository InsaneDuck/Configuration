# xmlsec1
# Autogenerated from man page /usr/lib/jvm/default/man/man1/xmlsec1.1.gz
...
complete -c xmlsec1 -l verification-gmt-time -d 'the GMT time in "YYYY-MM-DD HH:MM:SS" format used certificates verification'
