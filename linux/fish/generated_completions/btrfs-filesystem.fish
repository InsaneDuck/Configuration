# btrfs-filesystem
# Autogenerated from man page /usr/lib/jvm/default/man/man8/btrfs-filesystem.8.gz
...
complete -c btrfs-filesystem -s U -l uuid -d 'specify UUID to use, or a special value: clear (all zeros), random, time (tim…'
