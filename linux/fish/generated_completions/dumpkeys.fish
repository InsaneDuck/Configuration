# dumpkeys
# Autogenerated from man page /usr/lib/jvm/default/man/man1/dumpkeys.1.gz
...
complete -c dumpkeys -s S -l shape -d 'Available shapes: . LP . RS  2 default output. RE . LP '
complete -c dumpkeys -s 1 -l separate-lines -d 'This forces  dumpkeys to write one line per (modifier,keycode) pair'
...
complete -c dumpkeys -s C -l console -d 'The affected console device can be specified using the  -C (or  --console ) o…'
complete -c dumpkeys -s v -l verbose -d 'Turn on verbose output. LP'
