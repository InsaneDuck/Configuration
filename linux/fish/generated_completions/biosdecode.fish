# biosdecode
# Autogenerated from man page /usr/lib/jvm/default/man/man8/biosdecode.8.gz
complete -c biosdecode -s d -l dev-mem -d 'Read memory from device FILE (default: /dev/mem)'
complete -c biosdecode -l pir -d 'Decode the details of the PCI IRQ routing table.  Only full mode is supported'
