# enchant-2
# Autogenerated from man page /usr/lib/jvm/default/man/man1/enchant-2.1.gz
...
complete -c enchant-2 -s v -d 'display version information and exit FILES AND DIRECTORIES See enchant (5) fo…'
