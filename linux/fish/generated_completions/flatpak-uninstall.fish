# flatpak-uninstall
# Autogenerated from man page /usr/lib/jvm/default/man/man1/flatpak-uninstall.1.gz
...
complete -c flatpak-uninstall -s u -l user -d 'Uninstalls from a per-user installation'
