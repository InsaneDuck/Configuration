# git-rev-parse
# Autogenerated from man page /usr/lib/jvm/default/man/man1/git-rev-parse.1.gz
...
complete -c git-rev-parse -l exclude-hidden -d 'Do not include refs that would be hidden by git-receive-pack or git-upload-pa…'
