# bwrap
# Autogenerated from man page /usr/lib/jvm/default/man/man1/bwrap.1.gz
...
complete -c bwrap -l disable-userns -d 'Prevent the process in the sandbox from creating further user namespaces, so …'
complete -c bwrap -l assert-userns-disabled -d 'Confirm that the process in the sandbox has been prevented from creating furt…'
