# numactl
# Autogenerated from man page /usr/lib/jvm/default/man/man8/numactl.8.gz
...
complete -c numactl -l preferred-many -d 'Preferably allocate memory on nodes, but if memory cannot be allocated there …'
