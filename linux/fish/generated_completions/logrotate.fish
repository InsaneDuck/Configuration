# logrotate
# Autogenerated from man page /usr/lib/jvm/default/man/man8/logrotate.8.gz
...
complete -c logrotate -l wait-for-state-lock -d 'Wait until lock on the state file is released by another logrotate process'
