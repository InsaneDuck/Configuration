# flac
# Autogenerated from man page /usr/lib/jvm/default/man/man1/flac.1.gz
...
complete -c flac -l sector-align -d 'Align encoding of multiple CD format files on sector boundaries'
...
complete -c flac -l sign -d 'Set the sign of samples (the default is signed)'
...
complete -c flac -l force-aiff-format -d 'Force the decoder to output AIFF format'
complete -c flac -l force-rf64-format -d 'Force the decoder to output RF64 format'
complete -c flac -l force-wave64-format -d 'Force the decoder to output Wave64 format'
...
complete -c flac -l no-sector-align
