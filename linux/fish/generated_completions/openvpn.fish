...
complete -c openvpn -l disable-dco -d 'Disable \\(dqdata channel offload\\(dq (DCO)'
complete -c openvpn -l disable-occ -d 'DEPRECATED Disable \\(dqoptions consistency check\\(dq (OCC) in configurations …'
