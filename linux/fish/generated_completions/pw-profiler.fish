# pw-profiler
# Autogenerated from man page /usr/lib/jvm/default/man/man1/pw-profiler.1.gz
...
complete -c pw-profiler -s o -l output -d 'Profiler output name (default \\(dqprofiler. log\\(dq)'
