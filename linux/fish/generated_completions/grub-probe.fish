# grub-probe
# Autogenerated from man page /usr/lib/jvm/default/man/man8/grub-probe.8.gz
...
complete -c grub-probe -s v -l verbose -d 'print verbose messages (pass twice to enable debug printing)'
