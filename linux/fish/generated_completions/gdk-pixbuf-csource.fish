# gdk-pixbuf-csource
# Autogenerated from man page /usr/lib/jvm/default/man/man1/gdk-pixbuf-csource.1.gz
complete -c gdk-pixbuf-csource -l stream -d 'Generate pixbuf data stream: a single string containing a serialized GdkPixda…'
complete -c gdk-pixbuf-csource -l struct -d 'Generate GdkPixdata structure; your code needs the GdkPixdata structure defin…'
...
complete -c gdk-pixbuf-csource -s h -l help -d 'Prints a brief help and exit'
complete -c gdk-pixbuf-csource -s v -l version -d 'Prints the tool version and exit'
complete -c gdk-pixbuf-csource -l g-fatal-warnings -d 'Makes warnings fatal, and causes the program to abort.  SEE ALSO'
