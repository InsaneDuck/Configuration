# visudo
# Autogenerated from man page /usr/lib/jvm/default/man/man8/visudo.8.gz
...
complete -c visudo -s I -d 'Disable the editing of include files unless there is a pre-existing syntax er…'
