# git-config
# Autogenerated from man page /usr/lib/jvm/default/man/man1/git-config.1.gz
...
complete -c git-config -l stdout -d 'is in use to escape "^>+From " lines.  filter. <driver>. clean'
