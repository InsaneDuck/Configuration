# factor
# Autogenerated from man page /usr/lib/jvm/default/man/man1/factor.1.gz
complete -c factor -s h -l exponents -d 'print repeated factors in form p^e unless e is 1'
