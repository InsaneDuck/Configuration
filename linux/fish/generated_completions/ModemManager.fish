# ModemManager
# Autogenerated from man page /usr/lib/jvm/default/man/man8/ModemManager.8.gz
complete -c ModemManager -l filter-policy -d 'Specify which ports are probed and how: \'ALLOWLIST-ONLY\' Only devices or port…'
